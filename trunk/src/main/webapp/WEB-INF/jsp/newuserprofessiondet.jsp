		...
		<div class="row flex-xl-nowrap">
				...
				<main class="col-12 col-md-9 col-xl-8  bd-content" role="main"><!-- py-md-3 pl-md-5 -->
					...
					<div class="card mb-1 border-light">
						...
						<div class="card-body">
							<form:form id="user-profession-det" modelAttribute="form">
								<div class="card mb-1">
									<div class="card-body">
										<div class="row">
											...
											<div class="col-12 col-md-6">
												...
												<form:input path="companyCity" class="form-control"></form:input>
												<form:errors path="companyCity" />
											</div>
											<div class="col-12 col-md-6">
												<label class="col-form-label">Designation</label>
												<form:input path="designation" class="form-control"></form:input>
												<form:errors path="designation" /> 
											</div>
											<div class="col-12 col-md-6">
												<label class="col-form-label">Joining Year</label>
												<form:input path="joiningYear" class="form-control"></form:input>
												<form:errors path="joiningYear" />
											</div>
											<div class="col-12 col-md-6">
												<label class="col-form-label">Leaving Year</label>
												<form:input path="leavingYear" class="form-control"></form:input>
												<form:errors path="leavingYear" />
											</div>
										</div>
									</div>
									<div class="card-body">
