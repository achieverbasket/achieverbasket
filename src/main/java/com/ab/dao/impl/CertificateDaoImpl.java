...
public class CertificateDaoImpl implements CertificateDao{
	...
	public Certificate saveCertificate(Certificate certificate) {
		...
		try {
			...
			String sql = "INSERT INTO CERTIFICATE (CERTIFICATE_ID, CERTIFICATE_NAME, CANDIDATE_ID, ISSUER_ID,CERTIFICATE_TYPE, IS_TEMPLATE_BASED, ISSUE_DATE, END_DATE, CERTIFICATE_TEMPLATE_ID, FILE_PATH, VERIFICATION_STATUS, "
...
//			System.out.println("end date formated: "+new Date(format.parse(certificate.getEndDate()).getTime()));
			...
			if(null!=certificate.getCertificateFile()) {
				...
				//certificate.setTemplateBased(false);
			}
			...
			jdbcTemplate.update(sql, certificateId, 
					...
					certificate.isTemplateBased()==true?1:0,
	...
	public void updateCertificate(Certificate certificate) {
		String sql = "UPDATE CERTIFICATE SET CERTIFICATE_NAME=?, ISSUE_DATE=?, END_DATE=?,"
				...
				+ " CERTIFICATE_TYPE=?, IS_TEMPLATE_BASED, MODIFIED_TIME=SYSDATE() WHERE CERTIFICATE_ID=?";
	...
	public Certificate getCertificate(Long certificateId) {
		...
		return jdbcTemplate.query(sql, new Object[] {certificateId}, (ResultSetExtractor<Certificate>) rs -> {
				...
				certificate.setTemplateBased(rs.getBoolean("IS_TEMPLATE_BASED"));
	...
	public List<Certificate> getIssuerCertificates(Long issuerId) {
		String sql = "SELECT CERTIFICATE_NAME, CERTIFICATE_ID, ISSUE_DATE, END_DATE, CERTIFICATE_TEMPLATE_ID, FILE_PATH, VERIFICATION_STATUS, VERIFIED_BY_ID, VERIFIED_DATE, CERTIFICATE_TYPE, IS_TEMPLATE_BASED, SOCIAL_ACTIVITY_ID, CREATED_BY, CREATED_TIME, MODIFIED_BY, MODIFIED_TIME FROM CERTIFICATE WHERE ISSUER_ID=?";
