...
public class Certificate implements Serializable{
	...
	public String toString()
	{
		return "certificateId: "+certificateId+" issuerId"+issuerId+" candidateId: "+candidateId+" certificateName: "+certificateName+" certificateType:"
				+certificateType+ "candidate: "+candidate+ " preferenceStatusType: "+preferenceStatusType+" issueDate:"+issueDate+" endDate:"+ endDate+"	certificateTemplate: "+certificateTemplate+
